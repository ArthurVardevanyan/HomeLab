...
helm template arc \
    ...
    oci://ghcr.io/actions/actions-runner-controller-charts/gha-runner-scale-set-controller > /tmp/github-arc-systems.yaml
...
helm template "${INSTALLATION_NAME}" \
 ...
 oci://ghcr.io/actions/actions-runner-controller-charts/gha-runner-scale-set  > /tmp/github-runner-scale-set.yaml
```
